...
curl_setopt_array(
	$curl,
	array(
		CURLOPT_URL            => 'https://localhost/wp-json/wc/v3/products',
		...
		CURLOPT_POSTFIELDS     => array(
			'TokenExpiration_token_key'    => '45',
			'TokenExpiration_token_secret' => '44',
		),
		CURLOPT_HTTPHEADER     => array(
			...
			'Cookie: mailchimp_landing_site=http%3A%2F%2Flocalhost%2Foauth1%2Frequest',
		),
	)
);
